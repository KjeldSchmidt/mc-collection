...
#define MAXIMUM_BRIGHTNESS_PER_CHANNEL 50 // On a scale from 1-255, of course. Actual value may be very slightly higher.
#define SPEED_OF_LIGHT 200 // Speed of animation in <continued months or years later> . . . units?

#define RED_WAVES_PER_STRIP 1 // Experiment with these
